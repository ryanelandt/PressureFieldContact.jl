...
function makeInertiaTensor(quad_rule::TriTetQuadRule{N_zeta, NQ}, point::Vector{SVector{3,Float64}}, vec_vol_ind::Vector{SVector{N_zeta, Int64}}, rho::Float64, thickness::Union{Nothing,Float64}) where {N_zeta, NQ}
...
function centroidVolumeCombo(point::Vector{SVector{3,Float64}}, vec_vol_ind::Vector{SVector{N, Int64}}, thickness::Union{Nothing,Float64}) where {N}
    v_cum, c_cum = 0.0, 0.0
    for ind_k = vec_vol_ind
        points_simplex_k = point[ind_k]
